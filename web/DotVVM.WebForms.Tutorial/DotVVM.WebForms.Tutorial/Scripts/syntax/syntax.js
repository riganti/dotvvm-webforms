var TinySyntaxHighlighter =
    {
        ...
        highlightBlock: function (preElement) {
            ...
            if (m != null && m.length === 2) {
                if (TinySyntaxHighlighter[preElement.className]) {
                    ...
                    preElement.innerHTML = TinySyntaxHighlighter.highlightSyntax
                        (
                        preElement.textContent || preElement.innerText,
                        TinySyntaxHighlighter[preElement.className]
                        );
                }
            }
        },
        ...
        htmlEncode: function (str) {
            return str.replace(/&/g, "&amp;").replace(new RegExp("\"", "g"), "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
                .replace(/\r\n/g, "<br />")
                .replace(/\n\r/g, "<br />")
                .replace(/\n/g, "<br />")
                .replace(/\r/g, "<br />");
